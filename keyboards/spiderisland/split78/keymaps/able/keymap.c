...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        QK_GESC,          XXXXXXX, XXXXXXX, QK_BACKLIGHT_DOWN,   QK_BACKLIGHT_UP,   XXXXXXXX,   XXXXXXX,   KC_MEDIA_PREV_TRACK,   KC_MEDIA_STOP,   KC_MEDIA_NEXT_TRACK,   KC_AUDIO_MUTE,  KC_AUDIO_VOL_DOWN,  KC_AUDIO_VOL_UP,
